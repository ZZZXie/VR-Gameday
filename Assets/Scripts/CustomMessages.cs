...
public class CustomMessages : Singleton<CustomMessages>
{
    ...
    {
        chatMessage = MessageID.UserMessageIDStart,
        Max
    }
    ...
    private void InitializeMessageHandlers()
    {
        ...
        for (byte index = (byte)TestMessageID.chatMessage; index < (byte)TestMessageID.Max; index++)
        {
    ...
    public void SendMessageOperation(MessageIO msgIO)
    {
        // If we are connected to a session, broadcast our head info
        if (serverConnection != null && serverConnection.IsConnected())
        {
            // Create an outgoing network message to contain all the info we want to send
            NetworkOutMessage msg = CreateMessage((byte)TestMessageID.chatMessage);
            msg.Write(msgIO.user_name);
            msg.Write(msgIO.operation);
            msg.Write(msgIO.channel);
            msg.Write(msgIO.chat_message);
